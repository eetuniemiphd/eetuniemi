...
- 5.5.2021 *Ohjaa IAM-jalkautusta prosesseilla*. Prosessipäivät-tapahtuma, kutsuttu puhuja. Materiaalit eivät julkisesti saatavilla.
...
- 6.9.2018 *IAM-arkkitehtuurin kuvaaminen käytännössä*. Coalan webinaari (Oppia.fi). [Tallenne ja lisätiedot (vaatii rekisteröitymisen)](https://oppia.fi/webinaarit/359/coala/webinaari-iam-arkkitehtuurin-kuvaaminen-kaytannossa)
- 22.5.2018 *Viritä kokonaisarkkitehtuurisi kisakuntoon kypsyystasomallilla*. Coalan webinaari (Oppia.fi). [Tallenne ja lisätiedot (vaatii rekisteröitymisen)](https://oppia.fi/webinaarit/239/coala/webinaari-virita-kokonaisarkkitehtuurisi-kisakuntoon-kypsyystasomallilla)
- 16.2.2018 *Onnistu käyttäjä- ja pääsynhallinnan (IAM) kehittämisessä*. Coalan webinaari (Oppia.fi). [Tallenne ja lisätiedot (vaatii rekisteröitymisen)](https://oppia.fi/webinaarit/235/coala/webinaari-onnistu-kayttaja-ja-paasynhallinnan-iam-kehittamisessa)
...
- 23.5.2017 *IAM as an enabler for GDPR compliance*. Coala Breakfast Seminar. Materiaalit eivät julkisesti saatavilla.
...
- 12.10.2017 *Kokonaisarkkitehtuurin hyödyt*. PM Club Turku, kutsuttu puhuja. Materiaalit eivät julkisesti saatavilla.
- 22.5.2017 *Kokonaisarkkitehtuurin hyötyjen syntyminen*. JHKA-työryhmän kokous, kutsuttu puhuja. Materiaalit eivät julkisesti saatavilla.
- 16.3.2017 *Kokonaisarkkitehtuurin hyödyt*. Sytyke ry:n ja Tietoturva ry:n kevätseminaari, kutsuttu puhuja. Materiaalit eivät julkisesti saatavilla.
- 25.1.2017 Kokonaisarkkitehtuurin hyödyt, KAOS-tilaisuus, kutsuttu puhuja. Materiaalit eivät julkisesti saatavilla.
...
- 22.2.2022 *Töissä arkkitehtuurikonsulttina*. Esitys kurssilla Kokonaisarkkitehtuuri käytännössä (Jyväskylän yliopisto). Materiaalit eivät julkisesti saatavilla.
